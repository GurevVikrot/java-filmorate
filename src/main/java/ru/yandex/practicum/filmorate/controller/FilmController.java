...
public class FilmController {
    ...
    @DeleteMapping
    public String deleteFilm(@NotNull @RequestParam Integer id) {
    ...
    @GetMapping("/{id}")
    public Film getFilm(@NotNull @PathVariable Integer id) {
    ...
    public boolean addLikeToFilm(@NotNull @PathVariable Integer id,
    ...
    public boolean deleteLikeFromFilm(@NotNull @PathVariable Integer id,
                                      @NotNull @PathVariable Integer userId) {
